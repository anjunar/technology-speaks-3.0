        ...
        form(passwordChangeForm) {
          ...
          onSubmit_= { (_: Form[PasswordChange]) =>
            ...
            if (currentPassword.isEmpty) {
              ...
              Api.link(changePasswordLink.get).invoke(passwordChangeForm).read[JsonResponse]
                .foreach { response =>
        ...
        form(createPasswordForm) {
          ...
          onSubmit_= { (_: Form[CreatePassword]) =>
            ...
            if (newPassword.isEmpty) {
              ...
              Api.link(createPasswordLink.get).invoke(createPasswordForm).read[JsonResponse]
